...
const settings = () => {
  ...
  const addRadioButtonListeners = async () => {
    document.querySelectorAll(".settings-radio").forEach((element) => {
  ...
  const addSettingsMenuToggle = async () => {
    document.querySelectorAll(".toggle-settings").forEach((element) => {
  ...
  const handleFontSizes = async () => {
    ...
    document
      ...
      .addEventListener("change", (event) => {
        document.getElementById("html").style.fontSize =
  ...
  const setThemeIcon = () => {
    ...
    document
      .querySelectorAll("i[data-theme=" + theme + "]")
      .forEach((element) => {
  ...
  const handleThemes = async () => {
    ...
    document.querySelectorAll(".theme-selector").forEach((element) => {
      element.addEventListener("click", (event) => {
        ...
        storeSetting({
          name: "setting_theme",
          value: event.currentTarget.getAttribute("data-theme"),
        });
        initializeSettings();
        setUpStatusBar();
      });
  ...
  const getSettingsLink = () => {
    let params = {};
    document.querySelectorAll(".settings-radio:checked").forEach((element) => {
  ...
  const bindShowSettingsLink = async () => {
    document.getElementById("settings-link").value = getSettingsLink();
    document.querySelectorAll(".show-settings-link").forEach((element) => {
      element.addEventListener("click", (event) => {
    ...
    document
      .getElementById("settings-link-copy")
