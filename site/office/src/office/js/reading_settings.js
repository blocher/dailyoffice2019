...
class ReadingEnabler {
  ...
  async mass() {
    ...
    if (
      ...
      document.getElementById(this.prefix + "abbreviated-mass-reading")
    ) {
      return false;
    }
    return true;
  ...
  async full() {
    ...
    if (
      document.getElementById(this.prefix + "alternate-abbreviated-reading")
    ) {
      return false;
    }
    return true;
  ...
  async getHideAndShow() {
    if (await this.mass()) {
      const hide = [
        "alternate-reading",
        "abbreviated-reading",
        "alternate-abbreviated-reading",
        "main-reading",
        "abbreviated-mass-reading",
      ];
      ...
      return [hide, show];
    } else if ((await this.main()) && (await this.full())) {
      // main, full
      const hide = [
        "alternate-reading",
        "abbreviated-reading",
