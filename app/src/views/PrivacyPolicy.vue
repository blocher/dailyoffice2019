<template>
  <div class="small-container">
    ...
    <p>
      This privacy policy applies to the The Daily Office web application and
      app (hereby referred to as "Application") that was created by Daily
      Office, LLC (hereby referred to as "Service Provider") as a Free service.
    ...
    <p>
      ...
      please contact them at feedback@dailyoffice2019.com and they will respond
    ...
    <div>
      ...
      <p>
        ...
        (feedback@dailyoffice2019.com) so that they will be able to take the
        necessary actions.
      </p>
    </div>
    ...
    <p>
      ...
      via email at feedback@dailyoffice2019.com.
    </p>
  </div>
</template>
