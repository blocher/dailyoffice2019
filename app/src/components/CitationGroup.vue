  ...
  <p>
    <span v-for="(reading, index) in readings" :key="index">
      ...
      <span
        v-if="
          reading.abbreviated &&
          reading.abbreviated.citation != reading.full.citation
        "
      >
        &nbsp;<em
          >[or
          <a
            ...
            >{{ reading.abbreviated.citation }}</a
          >]</em
        >
      </span>
      <span v-if="index != Object.keys(readings).length - 1"
        >&nbsp;<em>or</em>&nbsp;</span
      >
    </span>
  </p>
