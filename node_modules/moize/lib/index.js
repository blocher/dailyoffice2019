...
var _maxAge = require("./maxAge");

var _options = require("./options");

var _stats = require("./stats");

exports.collectStats = _stats.collectStats;
...
function moize(fn, options) {
  if (options === void 0) {
    options = _constants.DEFAULT_OPTIONS;
  }

  if (fn.isMoized) {
    // $FlowIgnore if moized, originalFunction and options exist
    return moize(fn.originalFunction, (0, _utils.mergeOptions)(fn.options, options));
  }
  ...
  if (typeof fn === 'object') {
    return function (curriedFn, curriedOptions) {
      ...
      return (
        ...
        moize(curriedFn, (0, _utils.mergeOptions)(fn, curriedOptions)) : // $FlowIgnore fn is actually an object of options
        moize((0, _utils.mergeOptions)(fn, curriedFn))
      );
    };
    /* eslint-enable */
  }

  var coalescedOptions = Object.assign({}, _constants.DEFAULT_OPTIONS, options, {
    maxArgs: typeof options.maxArgs === 'number' && options.maxArgs >= 0 ? options.maxArgs : _constants.DEFAULT_OPTIONS.maxArgs,
    maxSize: typeof options.maxSize === 'number' && options.maxSize >= 0 ? options.maxSize : _constants.DEFAULT_OPTIONS.maxSize,
    profileName: options.profileName || (0, _stats.getDefaultProfileName)(fn)
  });
  var expirations = [];
  ...
  var isEqual = (0, _options.getIsEqual)(coalescedOptions);
  var isMatchingKey = (0, _options.getIsMatchingKey)(coalescedOptions);
  var maxAgeOptions = (0, _maxAge.getMaxAgeOptions)(expirations, coalescedOptions, isEqual, isMatchingKey);
  var statsOptions = (0, _stats.getStatsOptions)(coalescedOptions);
  var transformKey = (0, _options.getTransformKey)(coalescedOptions);
  var microMemoizeOptions = Object.assign({}, customOptions, {
    isEqual: isEqual,
    isMatchingKey: isMatchingKey,
    isPromise: isPromise,
    maxSize: maxSize,
    onCacheAdd: (0, _options.createOnCacheOperation)((0, _utils.combine)(onCacheAdd, maxAgeOptions.onCacheAdd, statsOptions.onCacheAdd)),
    onCacheChange: (0, _options.createOnCacheOperation)(onCacheChange),
    onCacheHit: (0, _options.createOnCacheOperation)((0, _utils.combine)(onCacheHit, maxAgeOptions.onCacheHit, statsOptions.onCacheHit)),
    transformKey: transformKey
  });
  return (0, _instance.augmentMoizeInstance)((0, _microMemoize.default)(fn, microMemoizeOptions), {
...
moize.collectStats = _stats.collectStats;
/**
 * @function
 * @name compose
 * @memberof module:moize
...
moize.compose = function () {
  ...
  return _utils.compose.apply(null, arguments) || moize;
};
/**
 * @function
 * @name deep
...
moize.getStats = _stats.getStats;
/**
 * @function
...
moize.isCollectingStats = function isCollectingStats() {
  return _stats.statsCache.isCollectingStats;
};
/**
 * @function
 * @name isMoized
