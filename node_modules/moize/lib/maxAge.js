...
exports.getMaxAgeOptions = exports.createOnCacheHitResetExpiration = exports.createOnCacheAddSetExpiration = exports.createTimeout = exports.clearExpiration = void 0;
...
var clearExpiration = function clearExpiration(expirations, key, shouldRemove) {
  var expirationIndex = (0, _utils.findExpirationIndex)(expirations, key);
...
exports.clearExpiration = clearExpiration;

var createTimeout = function createTimeout(expirationMethod, maxAge) {
...
var createOnCacheAddSetExpiration = function createOnCacheAddSetExpiration(expirations, options, isEqual, isMatchingKey) {
  ...
  var findKeyIndex = (0, _utils.createFindKeyIndex)(isEqual, isMatchingKey);
  /**
   * @private
   *
   * @function onCacheAdd
  ...
  return function onCacheAdd(cache, moizedOptions, moized) {
    ...
    if (!~(0, _utils.findExpirationIndex)(expirations, key)) {
...
exports.createOnCacheAddSetExpiration = createOnCacheAddSetExpiration;
...
exports.createOnCacheHitResetExpiration = createOnCacheHitResetExpiration;
...
exports.getMaxAgeOptions = getMaxAgeOptions;